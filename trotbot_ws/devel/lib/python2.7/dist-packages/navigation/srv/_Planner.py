...
class PlannerResponse(genpy.Message):
  _md5sum = "3b62fc16eef217a484b6eb0641685257"
  _type = "navigation/PlannerResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """std_msgs/Float32MultiArray path
bool ack
...
uint32 stride  # stride of given dimension"""
  __slots__ = ['path','ack']
  _slot_types = ['std_msgs/Float32MultiArray','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.path is None:
        self.path = std_msgs.msg.Float32MultiArray()
      if self.ack is None:
        self.ack = False
    else:
      self.path = std_msgs.msg.Float32MultiArray()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_I().pack(self.path.layout.data_offset))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.path.layout.data_offset,) = _get_struct_I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.path.data = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 1
      (self.ack,) = _get_struct_B().unpack(str[start:end])
      self.ack = bool(self.ack)
...
class Planner(object):
  ...
  _md5sum = '59d496e471e2ce1a2e0dd836fb1cdfb4'
