...
from utils_scan import los_optimizer_scan, scan_obstacle_checker , make_obstacles_scan , check_intersection_scan
        ...
        if check_intersection_scan([start_point, goal_point], line_obstacles):
            while True:
                ...
                if math.isnan(new_point[0]):
                    ...
                    node_list = los_optimizer_scan(list(path) , line_obstacles)
				...
				# or not check_intersection_scan(\
